...
public class BlobRenameRegexActionTest {
    ...
    public void saveEntityWithBlob_WhenRenamedShouldNotExists()
        ...
        BlobRenameRegexAction blobRenameRegexAction = new BlobRenameRegexActionBuilder()
                .regexPattern("photo\\w*")
                .replacement("profilePhoto")
                .build();

        Entity entityToUpdate = new EntityBuilder()
                .environment(environment)
                .entityId(createdEntity.entityId())
                .addActions(blobRenameRegexAction)
                .build();
